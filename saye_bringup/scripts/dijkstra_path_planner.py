...
class SimpleDijkstraPlanner:
    ...
    def dijkstra(self, start: Tuple[float, float], goal: Tuple[float, float]) -> Tuple[Optional[List[Tuple[float, float]]], dict]:
...
class DijkstraPathPlannerNode(Node):
    ...
    def plan_path(self, start_x, start_y, goal_x, goal_y):
        ...
        path, metrics = self.planner.dijkstra((start_x, start_y), (goal_x, goal_y))
...
if __name__ == "__main__":
    ...
    path, metrics = node.planner.dijkstra(start, goal)
