#!/bin/bash
# Phase 0-3 Re-test - Verify Phases 0-3 still work after Phase 4
#
...
echo "============================================================"
echo "Phase 0-3 Re-test - Verify Previous Phases Still Work"
echo "============================================================"
echo
...
# Test observation includes battery
if python3 -c "
...
obs = env.reset()
print(f'✓ Observation shape: {obs.shape} (expected: 721)')
assert obs.shape == (721,), f'Expected shape (721,), got {obs.shape}'
assert 0.0 <= obs[720] <= 1.0, f'Battery level {obs[720]} out of range [0,1]'
env.destroy_node()
rclpy.shutdown()
print('✓ Observation includes battery level')
" 2>/dev/null; then
    echo "✓ Observation includes battery level"
else
    echo "✗ Observation battery integration failed"
    exit 1
fi

echo
echo "============================================================"
echo "Phase 0-3 Re-test: All checks passed!"
echo "============================================================"
echo
echo "Previous phases remain valid after Phase 4 changes."
