#!/bin/bash
# Phase 0-4 Re-test - Verify Phases 0-4 still work after Phase 5
#
...
echo "============================================================"
echo "Phase 0-4 Re-test - Verify Previous Phases Still Work"
echo "============================================================"
echo
...
# Test observation includes goal deltas
if python3 -c "
...
assert 0.0 <= obs[720] <= 1.0, f'Battery level {obs[720]} out of range [0,1]'
# Goal deltas at indices 721-723
dx, dy, dtheta = obs[721], obs[722], obs[723]
print(f'✓ Goal deltas in observation: Δx={dx:.3f}, Δy={dy:.3f}, Δθ={dtheta:.3f}')
env.destroy_node()
rclpy.shutdown()
print('✓ Observation includes goal deltas')
" 2>/dev/null; then
    echo "✓ Observation includes goal deltas"
else
    echo "✗ Observation goal delta integration failed"
    exit 1
fi

echo
echo "============================================================"
echo "Phase 0-4 Re-test: All checks passed!"
echo "============================================================"
echo
echo "Previous phases remain valid after Phase 5 changes."
